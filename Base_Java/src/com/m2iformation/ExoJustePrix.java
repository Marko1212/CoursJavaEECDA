...
public class ExoJustePrix
{
    ...
    private static void jouerUnJeu() throws IOException
    {
        ...
        System.out.println("Vous devez deviner le juste prix...à vous de jouer!...");
        ...
        while (prix != justePrix)
        {
           ...
           try {
            prix = Integer.parseInt(input);
            	...
            	System.out.println("Vous devez entrez une valeur numérique!");
            }
            ++compteur;
            if (compteur >= 7) {
            	System.out.println("Vous avez dépassé le nombre de tentatives autorisé! Au revoir!");
            	return;
            }
            if (prix < justePrix)
        ...
        System.out.println("Vous avez gagné en " + compteur + " coup(s) !");
    }
