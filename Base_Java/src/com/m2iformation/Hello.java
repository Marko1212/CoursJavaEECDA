...
public class Hello {
	...
	public static void main(String[] args) {
		...
		//pour passer à la ligne (\n ne suffit pas sur Windows, surtout pour écrire dans
		//les fichiers; mieux vaut écrire \r\n partout, sur Windows)
		...
		if (i1 == i2) { //unboxing implicite effectué par le compilateur
		...
		//on vide d'abord le buffer, il faut le faire sinon le String ne sera pas lu (un 'bug' Java très ancien)
		sc.nextLine();
		
		//Si on n'a que des nextLine(), il n'y a pas ce bug, on peut chaîner les nextLine()
